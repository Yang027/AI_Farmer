...
<body>
    ...
    <form action="adduser.php" method="post">
        ...
        <!-- <input type="text" style="display:none" name="mail" value="<?php echo $row['email'] ?>" /> -->
    ...
    if (isset($_POST["Add"])) {
        ...
        if (mysqli_query($link, $sql)) // 執行SQL指令
        {
            if (mysqli_num_rows(mysqli_query($link, $sql)) > 0) {
                ...
                $sql2 = "INSERT INTO usergreenhouse (greenhouse_ID, mail) VALUES ('gh_" . $_POST["currgh"] . "_" . $num . "','" . $mail . "')";
