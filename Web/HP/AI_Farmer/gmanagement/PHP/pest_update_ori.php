...
<form action="pest_update.php" method="post">
   ...
   <!-- <div class="row mb-3 justify-content-md-center">
    ...
    <div class="row mb-3 justify-content-md-center">
      ...
      <div class="col-sm-6">
        <input type="text" name="feature" class="form-control" id="inputPassword3">
      </div>
    </div>
    <div class="row mb-3 justify-content-md-center">
    ...
    <div class="row mb-3 justify-content-md-center">
      ...
      <div class="col-sm-6">
        <input type="text" name="predict" class="form-control" id="inputPredict">
      </div>
    </div>
    <div class="row mb-3 justify-content-md-center">
      <label for="inputMedicine" class="col-sm-1 col-form-label text-center">藥品對策</label>
      <div class="col-sm-6">
        <input type="text" name="medicine" class="form-control" id="inputMedicine">
      </div>
    </div>
    <div class="row mb-3 justify-content-md-center">
