...
<head>
  <meta charset="utf-8" />
  <title>disease_plant_insert.php</title>
</head>
...
<body>
  ...
  if (isset($_POST["Insert"])) {
    ...
    // 建立新增記錄的SQL指令字串
    $sql = "INSERT INTO disease_plant (disease, plant_id) VALUES ('";
    $sql .= $_POST["disease"] . "','" . $_POST["plant_id"] . "')";
  ...
  <form action="disease_plant_insert.php" method="post">
    </br>
