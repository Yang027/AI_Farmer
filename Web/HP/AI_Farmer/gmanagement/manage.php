...
<body>
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: rgb(248, 195, 195);">
    <div class="container-fluid">
      <a class="navbar-brand" href="../homepage_manage.php">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="../homepage_manage.html" style="color: #1D3124;">Home</a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="../greenhouse_control/greenhouse_main.php" onclick="window.location = '<?php echo $login_url; ?>'">溫室</a>
          </li>
          <li class="nav-item">
        ...
        <!-- <input type="button" class="btn btn-outline-secondary" value="登出" onclick="location.href='../homepage_logout.php'"> -->
        <?php
