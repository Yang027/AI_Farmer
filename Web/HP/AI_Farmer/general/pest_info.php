...
<body>
    ...
    $query = "SELECT * FROM pest WHERE pest='$name'"; //搜尋 *(全部欄位) ，從 表staff
    $query_run = mysqli_query($con, $query); //$con <<此變數來自引入的 db_cn.php
    $sql = "SELECT * FROM pests_plant WHERE pest='$name'";
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="pest_search.php">
                    <font color="#7F5F3F">
                        蟲害知識庫
                    </font>
                </a></li>
    ...
    <div class="justify-content-center">
        <div class="row g-3 justify-content-center">
            ...
            <div class="col-8" style="background-color: #DCD4CB;">
                ...
                <h4 id="scrollspyHeading1">蟲害簡介</h4>
                <p><?php echo $intro; ?></p>
                <h4 id="scrollspyHeading1">蟲害特徵</h4>
