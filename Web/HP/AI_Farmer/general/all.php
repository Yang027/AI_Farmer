...
<head>
    ...
    <!-- Load Tempalte CSS -->
    <link rel="stylesheet" type="text/css" href="assets/css/templatemo.css">
...
<body>
    ...
    if (isset($_POST["find"])) {
        ...
        $query .= " WHERE plant_id like '%" . $_POST["find"] . "%'";
    ...
    <!-- <div class="row"> 
        <img class="box" src="../icon/field.png" height="50" width="50" align="right">
        <img class="box" src="../icon/chemical.png" height="50" width="50" align="right">
    </div> -->
    <div class="row line1 justify-content-center my-5">
        <form class="row" method="post" action="all.php">
        ...
        <div class="filter-btns shadow-md rounded-pill text-center col-auto">
            <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4 active" data-filter=".project" href="all.php">全部</a>
            <a class="filter-btn btn rounded-pill btn-outline-primary border-0 m-md-2 px-md-4" data-filter=".business" href="fruit.php">水果</a>
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($i < mysqli_num_rows($result)) {
            ...
            while ($j < 3) {
                ...
                if ($i <= mysqli_num_rows($result)) {
                    echo '<div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">';
                    echo '<div class="p-3">';
                    echo '<div class="card">';
                    ...
                    echo '<a href="all_info.php?item=' . $row['plant_id'] . '"><button class="button1">Read more <img class="vertical-align:middle;" src="../icon/click.png" height="25" width="25"></button></a>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
        ...
        echo  '<a href="all.php?page=1">首頁 </a>';
        echo '<a href="all.php?page=' . ($pagee - 1) . 'name=' . $_POST["find"] . '"><font color="#98814C">上一頁</a>';
        echo ' 當前是第 ' . $pagee . ' 頁 ';
        echo '<a href="all.php?page=' . ($pagee + 1) . 'name=' . $_POST["find"] . '"><font color="#98814C">下一頁  </a>';
        echo '  共 ' . $totall . ' 頁 ';
        echo '<a href="all.php?page=' . $totall . '"><font color="#98814C">尾頁</a>';
        echo '</h5>';
    } elseif ($url != "") {
        ...
        //mysqli_query << PHP 有很多種...指令(?) ，這其中一個，我現在還都是學到甚麼用什麼，沒辦法自己看手冊，然後實驗+學習使用。 
        ...
        $offset = ($page - 1) * $num;
        $sqll = "SELECT * FROM plant LIMIT $offset , $num";
        ...
        while ($i < mysqli_num_rows($resultt)) {
            ...
            while ($j < 3) {
                ...
                if ($i <= mysqli_num_rows($resultt)) {
                    ...
                    echo $row['plant_id'];
                    echo '</h5>';
                    echo '<p class="card-text pp" id="a">簡介:"' . $row['introduction'] . '"</p>';
                    echo '<a href="all_info.php?item=' . $row['plant_id'] . '"><button class="button1">Read more <img class="vertical-align:middle;" src="../icon/click.png" height="25" width="25"></button></a>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
        ...
        echo ' <h5 style="text-align:center; color:#98814C;>';
        echo  '<a href="all.php?page=1">首頁 </a>';
        echo '<a href="all.php?page=' . ($page - 1) . '"><font color="#98814C">上一頁</a>';
        echo ' 當前是第 ' . $page . ' 頁 ';
        echo '<a href="all.php?page=' . ($page + 1) . '"><font color="#98814C">下一頁  </a>';
        echo '  共 ' . $total . ' 頁 ';
        echo '<a href="all.php?page=' . $total . '"><font color="#98814C">尾頁</a>';
        echo '</h5>';
    }
    $con->close();
    ?>
