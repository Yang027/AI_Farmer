...
<body>
    ...
    if (isset($_POST["sug"])) {
        ...
        // $to = " aifarmer2022@gmail.com "; //收件者
        // $subject = "用戶建議"; //信件標題
        // $msg = $_POST["suggest"]; //信件內容
        // $headers = "From: " . $_POST["mail"]; //寄件者

        // if (mail("$to", "$subject", "$msg", "$headers")) :
        //     //    echo "信件已經發送成功。";//寄信成功就會顯示的提示訊息
        //     echo "<script type='text/javascript'>alert('我們已收到您的回覆，感謝您的建議！');</script>";
        // else :
    ...
    <form action="suggest.php" method="post">
        ...
        <div style="border:2px #ccc solid;border-radius:10px;background-color:#B5CAA0">
            ...
            <div class="row mb-3 justify-content-md-center">
                ...
                <div class="col-sm-6">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="感謝您撥冗填寫，請寫下您寶貴的建議" name="suggest"></textarea>
                </div>
            </div>
            <div class="d-md-flex justify-content-md-center">
                <button type="submit" class="btn" name="sug" style="background-color:#F6F4E8;">送出</button>
            </div>
        </div>
        <a href="#" onclick="location.href='new.php'">如果您想幫助我們完善資料，請點這裡</a>
