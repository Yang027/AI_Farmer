...
<body>
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="all.php">
                    <font color="#7F5F3F">
                        知識庫
                    </font>
                </a></li>
    ...
    <div class="container-fuild">
        <div class="row">
            <div class="col-2">
                <!-- <nav id="navbar-example3" style="background-color: #D6E4D8;" class="navbar flex-column align-items-stretch p-3">
                    <nav class="nav nav-pills flex-column" style="background-color: #D6E4D8;">
                        <a class="nav-link" href="#item-1">簡介</a>
                        <a class="nav-link" href="#item-2">栽培特性</a>
                        <a class="nav-link" href="#item-3">品種</a>
                        <a class="nav-link" href="#item-4">種植資訊</a>
                        <nav class="nav nav-pills flex-column">
                            <a class="nav-link ms-3 my-1" href="#item-4-1">撒種</a>
                            <a class="nav-link ms-3 my-1" href="#item-4-2">定值</a>
                            <a class="nav-link ms-3 my-1" href="#item-4-3">收穫</a>
                        </nav>
                        <a class="nav-link" href="#item-5">注意事項</a>
                        <a class="nav-link" href="#item-6">常見問題</a>
                    </nav>
                </nav> -->
            </div>
